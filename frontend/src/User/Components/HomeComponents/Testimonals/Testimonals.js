...
const Testimonial = () => {
  ...
  return (
    <section className="bg-[#e1dcd3]">
      <div className="mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24">
        <div className="max-w-7xl items-end justify-between sm:flex sm:pe-6 lg:pe-8">
          <h2 className=" traking-tight text-3xl font-bold text-gray-800 lg:text-4xl">
        ...
        <div className="-mx-6 mt-8 lg:col-span-2 lg:mx-0">
          <div id="keen-slider" className="keen-slider rounded-lg">
            <div className="keen-slider__slide rounded-lg">
              <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                {/* Content for first slide */}
                <div>
                  <div className="flex gap-0.5 text-green-500">❤️❤️❤️❤️❤️</div>

                  <div className="mt-4">
                    <p className="text-2xl font-bold text-rose-600 sm:text-3xl">
                      Mahendra & sneha Wedding
                    </p>
            ...
            <div className="keen-slider__slide rounded-lg">
              <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                ...
                <div>
                  <div className="flex gap-0.5 text-green-500">❤️❤️❤️❤️</div>

                  <div className="mt-4">
                    <p className="text-2xl font-bold text-rose-600 sm:text-3xl">
                      Pradnya & Pratik Wedding
                    </p>
